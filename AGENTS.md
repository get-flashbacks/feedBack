...
- **Error boundaries** — unhandled promise rejections and runtime errors in plugins should not crash the host. Wrap plugin entry points in try/catch; log to `console.error` with a `[Plugin]` prefix.
